...
const Cart = () => {
    ...
    const getCart = () => {
        let tempArray = [];
        if (cartItems && Array.isArray(products)) {
    ...
    const placeOrder = async () => {
        ...
        try {
            // FIX: Check against the 'paymentOption' state variable with the correct value "COD"
            ...
            // FIX: Check against 'paymentOption' with the correct value "Online"
    ...
    useEffect(() => {
        if (Array.isArray(products) && products.length > 0 && cartItems) {
            getCart();
        }
    }, [products, cartItems]);
    ...
    if (!Array.isArray(products) || !cartItems) return null;
        ...
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between text-lg font-medium text-black mt-3">
